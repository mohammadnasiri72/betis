...
export default function ModalEditUnit({ valBuilding , setFlag , handleCloseMenu , unit}) {
  ...
  return (
    <>
      ...
      <Stack onClick={handleClickOpen} className="text-teal-500">ویرایش</Stack>
      <BootstrapDialog
        sx={{ minHeight: 600 }}
        onClose={handleClose}
        ...
        <DialogContent dividers className="sm:min-w-[600px]">
          ...
          <div className="flex flex-wrap mt-5">
            <div className="flex relative sm:w-1/3 w-full px-1">
              <TextField
              InputProps={{
                endAdornment: <InputAdornment sx={{transform:'translateX(-30%)'}} position="start">نفر</InputAdornment>,
              }}
                size="small"
                label=" تعداد ساکنین"
              ...
              <div className="flex flex-col absolute left-0 top-0 h-full">
                <IoMdArrowDropup
                  onClick={() => setNumResidents(numResidents * 1 + 1)}
            ...
            <div className="flex relative sm:w-1/3 w-full px-1 sm:mt-0 mt-5">
              <TextField
              InputProps={{
                endAdornment: <InputAdornment sx={{transform:'translateX(-30%)'}} position="start">متر</InputAdornment>,
              }}
                size="small"
                label="مساحت"
                className="border rounded-lg w-full px-3"
