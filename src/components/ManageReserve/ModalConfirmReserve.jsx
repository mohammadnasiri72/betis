...
export default function ModalConfirmReserve({ setIsLoading, setFlag, myReserve }) {
  ...
  const RejectReserveHandler = () => {
    ...
    axios
      .put(
        `${mainDomain}/api/Reservation/Confirm/${myReserve.id}`,
        {},
        {
          headers: {
  ...
  return (
    <>
      <Tooltip title="تایید رزرو">
        <IconButton onClick={handleClickOpen}>
          <ThumbUpOffAltIcon className="text-emerald-500" />
        </IconButton>
      </Tooltip>
      <BootstrapDialog
        ...
        <DialogContent dividers>
          <div className="flex items-center">
            ...
            <div className="text-start px-3">
              <h4 style={{ color: themeMode === 'dark' ? '#fff' : '#000' }}>تایید رزرو</h4>
