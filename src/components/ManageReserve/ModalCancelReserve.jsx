...
export default function ModalCancelReserve({ setIsLoading, setFlag, myReserve }) {
  ...
  const RejectReserveHandler = () => {
    ...
    axios
      .put(
        `${mainDomain}/api/Reservation/Cancel/${myReserve.id}`,
        {},
        {
          headers: {
        ...
        <DialogContent dividers>
          <div className="flex items-center">
            ...
            <div className="text-start px-3">
              <h4 style={{ color: themeMode === 'dark' ? '#fff' : '#000' }}>کنسل </h4>
              <p className={themeMode === 'dark' ? 'text-[#fff8]' : 'text-[#0008]'}>آیا از کنسل مطمئن هستید؟</p>
            </div>
          </div>
        </DialogContent>
