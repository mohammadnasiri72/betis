...
export default function ModalRejectReserve({ setIsLoading, setFlag, myReserve }) {
  ...
  const RejectReserveHandler = () => {
    ...
    axios
      .put(
        `${mainDomain}/api/Reservation/Reject/${myReserve.id}`,
        {},
        {
          headers: {
      ...
      .then(() => {
        ...
        Toast.fire({
          icon: 'success',
          text: 'رد رزرو با موفقیت انجام شد',
          customClass: {
        ...
        <DialogContent dividers>
          <div className="flex items-center">
            ...
            <div className="text-start px-3">
              <h4 style={{ color: themeMode === 'dark' ? '#fff' : '#000' }}>رد رزرو</h4>
              <p className={themeMode === 'dark' ? 'text-[#fff8]' : 'text-[#0008]'}>آیا از رد مطمئن هستید؟</p>
            </div>
          </div>
        </DialogContent>
