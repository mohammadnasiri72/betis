...
export default function ModalDeleteService({ handleCloseMenu, setFlag, setIsLoading, service }) {
  ...
  const deleteServiceHandler = () => {
    setIsLoading(true);
    axios
      .delete(`${mainDomain}/api/Service/Delete/${service.id}`, {
        headers: {
        ...
        <DialogContent dividers>
          <div className="flex items-center">
            ...
            <div className="text-start px-3">
              <h4  style={{ color: themeMode === 'dark' ? '#fff' : '#000' }}>حذف خدمت</h4>
