          ...
          <DialogContent dividers>
            <div className="w-full flex-wrap flex ">
              ...
              <div className="flex flex-wrap items-start">
                {/* select from time */}
                <div className="sm:w-1/2 w-full mt-5 px-1">
                  <div className="flex items-start w-full">
                    ...
                    <div className='w-full'>
                      <DatePicker
                        ...
                        inputClass={errStartTime? "border w-full rounded-lg h-10 px-3 outline-red-500 outline-double" : 'border w-full rounded-lg h-10 px-3'}
                      ...
                      />
                      {errStartTime && <p className="text-red-500 text-start text-xs mt-1">*لطفا ساعت شروع را انتخاب کنید</p>}
                    </div>
                  </div>
                </div>
                {/* select end time */}
                <div className="sm:w-1/2 w-full mt-5 flex items-start px-1">
                  ...
                  <DatePicker
                    ...
                    children
                    inputClass={errEndTime? "border w-full rounded-lg h-10 px-3 outline-red-500 outline-double" : 'border w-full rounded-lg h-10 px-3'}
                    disableDayPicker
                    format="HH:mm"
                    plugins={[<TimePicker hideSeconds key={valTimeStart} />]}
                    calendarPosition="bottom-right"
                  ...
                  />
                  {errEndTime && <p className="text-red-500 text-start text-xs mt-1">*لطفا ساعت پایان را انتخاب کنید</p>}
                  </div>
                </div>
              </div>
