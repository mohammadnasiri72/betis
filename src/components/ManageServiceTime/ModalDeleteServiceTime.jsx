...
export default function ModalDeleteServiceTime({ handleCloseMenu, setFlag, setIsLoading, service }) {
  ...
  const deleteServiceTimeHandler = () => {
    setIsLoading(true);
    axios
      .delete(`${mainDomain}/api/ServiceTime/Delete/${service.id}`, {
        headers: {
        ...
        <DialogContent dividers>
          <div className="flex items-center">
            ...
            <div className="text-start px-3">
              <h4 style={{ color: themeMode === 'dark' ? '#fff' : '#000' }}>حذف زمان‌بندی</h4>
