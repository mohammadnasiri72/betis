          ...
          <>
            <RootStyle {...varSidebar}>
              <Stack direction="row" alignItems="center" justifyContent="space-between" sx={{ py: 2, pr: 1, pl: 2.5 }}>
                <Typography sx={{ color: themeMode === 'dark' ? '#fff' : '#000' }} variant="subtitle1">
                  تنظیمات
                </Typography>
                <div>
              ...
              <Scrollbar sx={{ flexGrow: 1 }}>
                <Stack spacing={3} sx={{ p: 3 }}>
                  <Stack spacing={1.5}>
                    <Typography sx={{ color: themeMode === 'dark' ? '#fff' : '#000' }} variant="subtitle2">
                      حالت صفحه
                    </Typography>
                    <SettingMode />
                  </Stack>
                  ...
                  {/* <Stack spacing={1.5}>
                    <Typography sx={{color: themeMode==='dark' ? '#fff' : ''}} variant="subtitle2">جهت صفحه</Typography>
                    <SettingDirection />
                  </Stack> */}
                  ...
                  {/* <Stack spacing={1.5}>
                    <Typography sx={{color: themeMode==='dark' ? '#fff' : ''}} variant="subtitle2">کش آمدن</Typography>
                    <SettingStretch />
                  </Stack> */}
