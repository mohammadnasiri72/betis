...
export default function EditCharge({ setFlag, setPageStateCharge, yearId, setYearId, chargeEdit, pageStateCharge }) {
  ...
  const [listItemCharge, setlistItemCharge] = useState(chargeEdit.chargeItems);
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `${mainDomain}/api/Charge/Type/GetList`,
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `${mainDomain}/api/Charge/DueDateType/GetList`,
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `${mainDomain}/api/Charge/ItemType/GetList`,
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `${mainDomain}/api/Charge/ItemCalcType/GetList`,
        ...
        <div className="border rounded-2xl p-3 mt-5">
          ...
          <div className="flex flex-wrap mt-4">
            <div className="lg:w-1/4 sm:w-1/2 w-full px-1 ">
              ...
              />
              {errTitleChargeItem && (
                <p className="text-xs text-red-500 text-start absolute">*لطفا یک عنوان برای آیتم شارژ انتخاب کنید</p>
              )}
            </div>
