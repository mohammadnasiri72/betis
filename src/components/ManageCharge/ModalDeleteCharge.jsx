...
export default function ModalDeleteCharge({ setIsLoading, setFlag, charge }) {
  ...
  const deleteChargetHandler = () => {
    setIsLoading(true);
    axios
      .delete(`${mainDomain}/api/Charge/Delete/${charge.id}`, {
        headers: {
  ...
  return (
    <>
      <Tooltip title="حذف">
        <IconButton className="text-xs cursor-pointer" onClick={handleClickOpen}>
