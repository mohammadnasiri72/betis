...
export default function ModalEditBuilding({ handleCloseMenu, building, setFlag }) {
  ...
  return (
    <>
      <Stack onClick={handleClickOpen} className="px-1 text-teal-500">
        ویرایش
      </Stack>
      <BootstrapDialog
        sx={{ minHeight: 600 }}
