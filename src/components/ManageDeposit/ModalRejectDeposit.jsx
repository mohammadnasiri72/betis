...
export default function ModalRejectDeposit({ setIsLoading, setFlag, deposite }) {
  ...
  const RejectDepositeHandler = () => {
    ...
    axios
      .put(
        `${mainDomain}/api/Deposit/Reject/${deposite.id}`,
        {},
        {
          headers: {
        ...
        <DialogContent dividers>
          <div className="flex items-center">
            ...
            <div className="text-start px-3">
              <h4 style={{ color: themeMode === 'dark' ? '#fff' : '#000' }}>لغو پرداخت</h4>
              <p className={themeMode === 'dark' ? 'text-[#fff8]' : 'text-[#0008]'}>آیا از لغو پرداخت مطمئن هستید؟</p>
            </div>
          </div>
        </DialogContent>
