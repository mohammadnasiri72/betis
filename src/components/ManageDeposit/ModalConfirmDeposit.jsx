...
export default function ModalConfirmDeposit({ setIsLoading, setFlag, deposite }) {
  ...
  //   confirm handler
  const RejectDepositeHandler = () => {
    setIsLoading(true);
    axios
      .put(`${mainDomain}/api/Deposit/Confirm/${deposite.id}`, {}, {
        headers: {
        ...
        <DialogContent dividers>
          <div className="flex items-center">
            ...
            <div className="text-start px-3">
              <h4 style={{ color: themeMode === 'dark' ? '#fff' : '#000' }}>تایید پرداخت</h4>
              <p className={themeMode === 'dark' ? 'text-[#fff8]' : 'text-[#0008]'}>آیا از تایید پرداخت مطمئن هستید؟</p>
            </div>
          </div>
        </DialogContent>
