...
export default function ModalArrivedSumman({ summon, setFlag }) {
  ...
  //   arrived handler
  const arrivedLobyManHandler = () => {
    setIsLoading(true);
    axios
      .put(
        `${mainDomain}/api/Summon/Done?id=${summon.id}`,
        {},
        {
          headers: {
        ...
        <DialogContent dividers>
          <div className="flex items-center">
            ...
            <div className="text-start px-3">
              <h4 style={{ color: themeMode === 'dark' ? '#fff' : '#000' }}>تایید احضار</h4>
              <p className={themeMode === 'dark' ? 'text-[#fff8]' : 'text-[#0008]'}>آیا از تایید احضار مطمئن هستید؟</p>
            </div>
          </div>
        </DialogContent>
