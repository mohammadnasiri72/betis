...
export default function ModalRejectedSumman({ setFlag, summon }) {
  ...
  //   reject handler
  const RejectSummanHandler = () => {
    setIsLoading(true);
    axios
      .post(
        `${mainDomain}/api/Summon/Cancel?id=${summon.id}`,
        {},
        {
          headers: {
        ...
        <DialogContent dividers>
          <div className="flex items-center">
            ...
            <div className="text-start px-3">
              <h4 style={{ color: themeMode === 'dark' ? '#fff' : '#000' }}>لغو احضار</h4>
              <p className={themeMode === 'dark' ? 'text-[#fff8]' : 'text-[#0008]'}>آیا از لغو احضار مطمئن هستید؟</p>
            </div>
          </div>
        </DialogContent>
