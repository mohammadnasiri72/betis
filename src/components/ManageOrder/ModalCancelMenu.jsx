...
export default function ModalCancelMenu({ setFlag, menu }) {
  ...
  const cancelMenuHandler = () => {
    ...
    // data.append('orderId', menu.id);
    
    axios
      .post(`${mainDomain}/api/Order/Cancel?orderId=${menu.id}`,{} , {
        headers: {
    ...
    <>
      ...
      {!loadingBtn && (
        <button
          ...
          className="px-1 py-1 whitespace-nowrap rounded-lg md:mt-0 mt-3 w-full border-red-500 border text-red-500 flex items-center justify-center duration-300 hover:bg-red-100 text-xs"
        >
