...
export default function ModalDoneMenu({ setFlag, menu }) {
  ...
  const nextLevelMenuHandler = () => {
    ...
    axios
      .put(
        `${mainDomain}/api/Order/Done?orderId=${menu.id}`,
        {},
        {
          headers: {
    ...
    <>
      {!loadingBtn && (
        <button
         ...
         className="px-1 py-1 w-full whitespace-nowrap rounded-lg border-emerald-500 border text-emerald-500 flex items-center justify-center duration-300 hover:bg-emerald-100 text-xs"
          // className="px-0 py-1 whitespace-nowrap w-full rounded-lg border-emerald-500 border text-emerald-500 flex items-center justify-center duration-300 hover:bg-emerald-100 text-xs"
        >
      ...
      {loadingBtn && (
        <button className="px-10 py-3 rounded-lg  border-emerald-500 border text-emerald-500 flex items-center justify-center duration-300 hover:bg-emerald-100 text-xs">
        ...
        <DialogContent dividers>
          <div className="flex items-center">
            ...
            <div className="text-start px-3">
              <h4 style={{ color: themeMode === 'dark' ? '#fff' : '#000' }}>انجام شده</h4>
