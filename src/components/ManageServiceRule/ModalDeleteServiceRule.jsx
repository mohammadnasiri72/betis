...
export default function ModalDeleteServiceRule({ handleCloseMenu, setIsLoading, setFlag, rule, setOpacity }) {
  ...
  //   delete handler
  const deleteServicRuleHandler = () => {
    setIsLoading(true);
    axios
      .delete(`${mainDomain}/api/ServiceRule/Delete/${rule.id}`, {
        headers: {
        ...
        <DialogContent dividers>
          <div className="flex items-center">
            ...
            <div className="text-start px-3">
              <h4 style={{ color: themeMode === 'dark' ? '#fff' : '#000' }}>حذف قانون</h4>
