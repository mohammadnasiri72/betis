...
export default function ModalDeleteRole({ handleCloseMenu, setFlag, setIsLoading, role }) {
  ...
  const deleteStaffHandler = () => {
    setIsLoading(true);
    axios
      .delete(`${mainDomain}/api/Role/Delete/${role.id}`, {
        headers: {
        ...
        <DialogContent dividers>
          <div className="flex items-center">
            ...
            <div className="text-start px-3">
              <h4 style={{ color: themeMode === 'dark' ? '#fff' : '#000' }}>حذف نقش</h4>
