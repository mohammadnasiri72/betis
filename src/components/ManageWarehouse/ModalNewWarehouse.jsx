...
import { Autocomplete, Box, FormControl, FormHelperText, InputAdornment, TextField } from '@mui/material';
...
export default function ModalNewWarehouse({ setFlag, listUnit, valUnitMain }) {
  ...
  useEffect(() => {
    if (valUnitMain && valUnitMain.id !== -1) {
      setValUnit(valUnitMain);
      setId(valUnitMain.number);
      setTitle(`پارکینگ ${valUnitMain.number}`);
    }
    if (valUnitMain && valUnitMain.id === -1) {
      setValUnit('');
    }
  ...
  const setNewWarehouseHandler = () => {
    ...
    if (id && title && valUnit) {
      ...
      axios
        .post(`${mainDomain}/api/Warehouse/Add`, data, {
          headers: {
      ...
      >
            ...
            <div className="sm:w-1/3 w-full px-1 sm:mt-0 mt-5">
              <FormControl className="w-full" error>
                <TextField
                  ...
                  label="شماره انباری"
                  // placeholder="شماره انباری را وارد کنید"
                  onChange={(e) => {
            ...
            <div className="sm:w-1/3 w-full px-1 sm:mt-0 mt-5">
              <FormControl className="w-full" error>
                <TextField
                  ...
                  id="outlined-multiline-flexible"
                  label="نام انباری"
                  // placeholder="نام انباری را وارد کنید"
                  onChange={(e) => {
        ...
        <DialogActions>
          <Button
            ...
            variant="contained"
            onClick={setNewWarehouseHandler}
          >
            ثبت
          </Button>
        </DialogActions>
