...
export default function ModalDeleteWarehouse({ handleCloseMenu, setFlag, setIsLoading, warehouse }) {
  ...
  const deletewarehouseHandler = () => {
    setIsLoading(true);
    axios
      .delete(`${mainDomain}/api/Warehouse/Delete/${warehouse.id}`, {
        headers: {
        ...
        <DialogContent dividers>
          <div className="flex items-center">
            ...
            <div className="text-start px-3">
              <h4 style={{color: themeMode==='dark'? '#fff' : '#000'}}>حذف انباری</h4>
