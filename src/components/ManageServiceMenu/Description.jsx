...
const Description = ({ description }) => {
  ...
  useEffect(() => {
    ...
    if (paragraphRef.current) {
      ...
      tempElement.innerText = description; // متن کامل
  ...
  return (
    <div className="text-justify flex items-center">
      <Paragraph
        ...
        style={{ whiteSpace: 'pre-line', color: themeMode === 'dark' ? '#fff' : '', padding: 0, margin: 0 }} // برای نمایش صحیح خطوط جدید
      >
        {description}
      </Paragraph>
    </div>
