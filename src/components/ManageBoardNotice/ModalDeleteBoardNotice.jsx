...
export default function ModalDeleteBoardNotice({ handleCloseMenu, setFlag, setIsLoading, info }) {
  ...
  //   delete handler
  const deleteBoardNoticeHandler = () => {
    setIsLoading(true);
    axios
      .delete(`${mainDomain}/api/BoardNotice/Delete/${info.id}`, {
        headers: {
        ...
        <DialogContent dividers>
          <div className="flex items-center">
            ...
            <div className="text-start px-3">
              <h4 style={{ color: themeMode === 'dark' ? '#fff' : '#000' }}>حذف اعلان</h4>
