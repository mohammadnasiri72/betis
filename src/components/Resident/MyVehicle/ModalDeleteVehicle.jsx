...
export default function ModalDeleteVehicle({ handleCloseMenu, setFlag, setIsLoading, vehicle }) {
  ...
  const deleteVehicleHandler = () => {
    setIsLoading(true);
    axios
      .delete(`${mainDomain}/api/Vehicle/Delete/${vehicle.id}`, {
        headers: {
        ...
        <DialogContent dividers>
          <div className="flex items-center">
            ...
            <div className="text-start px-3">
              <h4 style={{ color: themeMode === 'dark' ? '#fff' : '#000' }}>حذف وسیله نقلیه</h4>
