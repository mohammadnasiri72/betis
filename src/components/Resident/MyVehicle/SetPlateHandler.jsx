      ...
      {valTypeVehicle === 1 && (
        <div>
          ...
          >
            ...
            <div dir="ltr" className="flex px-1 w-full my-3 items-center justify-center">
              ...
              <div className="px-1  w-14 py-1">
                <TextField
                  style={{
                    backgroundColor: themeMode === 'dark' ? '' : '#f2f3f5',
                  }}
                  sx={{ '& .MuiInputBase-input': { fontSize: { xs: 12, sm: 16 } } }}
                  size="small"
                  name="part1"
                  value={part1}
                  onChange={(e) => {
              ...
              <div className=" w-14 py-1" dir="rtl">
              ...
              <span className="translate-y-1 pr-1">_</span>
              <div
                style={{ backgroundColor: themeMode === 'dark' ? '' : '#f2f3f5' }}
                className="px-1  w-20 flex items-center border  py-0 rounded-lg justify-between sm:h-10 h-9"
              >
                <TextField
                  sx={{
                    '& fieldset': { border: 'none' },
                    '& .MuiInputBase-input': { fontSize: { xs: 12, sm: 16 } },
                  }}
                  style={{
                    display: 'flex',
                ...
                <div
                  className={
                    themeMode === 'dark'
                      ? '  border-l border-[#fff8] relative w-1/4 h-full'
                      : '  border-l border-[#0008] relative w-1/4 h-full'
                  }
                >
