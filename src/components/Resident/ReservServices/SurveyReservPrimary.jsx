                      ...
                      <div className="flex">
                        ...
                        <div className="flex flex-col items-start px-2">
                          ...
                          <div className="flex mt-2 justify-around">
                            <div className="px-1">
                              {Number(reserve?.reservationRelatedInfo?.value) > 0 && (
                                <div className="relative bg-white border border-[#000a] rounded-lg overflow-hidden shadow-lg px-6">
                                  <div className="text-xs text-gray-900 tracking-wider mb-1">
                                    {reserve?.reservationRelatedInfo?.value?.slice(0, 3) || '***'}
                                  </div>
                                  <div className="text-xs text-gray-900 tracking-wider">
                                    {reserve?.reservationRelatedInfo?.value?.slice(3, 8) || '*****'}
                                  </div>
                              ...
                              {Number.isNaN(Number(reserve?.reservationRelatedInfo?.value)) && (
