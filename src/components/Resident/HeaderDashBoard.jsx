...
import { Divider, FormControl, IconButton, InputLabel, MenuItem, Select, Tooltip } from '@mui/material';
    ...
    <>
      <div className="flex justify-between px-2 pt-2 pb-0">
              ...
              <div>
                <Select size='small'
                 ...
                 >
                   ...
                   {
                     accounts.map((acc) => (
                       <MenuItem key={acc.id} size='small' value={acc.id}>{acc.title}</MenuItem>
                     ))
                   }
        ...
        <div className="flex items-center">
          ...
          {/* {<ToggleButton open={open} onToggle={showSettingBox} />} */}
          <div>
