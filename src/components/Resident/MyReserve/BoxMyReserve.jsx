                  ...
                  {Number.isNaN(Number(myReserve?.reservationRelatedInfo?.value)) && (
                    <div className="border-t border-b border-r border-[#000a] rounded-lg pr-2 flex justify-end items-center gap-2">
                      <div className="flex flex-col items-center justify-center">
                        ...
                        <span className="text-xs">{myReserve?.reservationRelatedInfo?.value.slice(0, 2)}</span>
                      </div>
                      <span className="text-[#0008]">|</span>
                      <span className="text-xs">{myReserve?.reservationRelatedInfo?.value.slice(3, 6)}</span>
                      <span className="text-xs">{myReserve?.reservationRelatedInfo?.value.slice(2, 3)}</span>
                      <span className="text-xs">{myReserve?.reservationRelatedInfo?.value.slice(6, 8)}</span>
