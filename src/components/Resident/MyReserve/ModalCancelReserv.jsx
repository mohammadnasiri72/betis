...
export default function ModalCancelReserv({ setIsLoading, setFlag, myReserve, setIsCancel }) {
  ...
  const deleteReserveHandler = () => {
    ...
    setLoadingBtn(true);
    axios
      .delete(`${mainDomain}/api/Reservation/Delete/${myReserve.id}`, {
        headers: {
  ...
  return (
    <>
      ...
      {loadingBtn && (
        <button
          // onClick={handleClickOpen}
          className="px-10 py-3 rounded-lg  border-red-500 border text-red-500 flex items-center justify-center duration-300 hover:bg-red-100 text-xs"
        >
        ...
        <DialogContent dividers>
          <div className="flex items-center">
            ...
            <div className="text-start px-3">
              <h4 style={{ color: themeMode === 'dark' ? '#fff' : '#000' }}>لغو رزرو</h4>
