...
export default function ModalArchiveResidents({ handleCloseMenu, resident, setIsLoading, setFlag }) {
        ...
        <DialogContent dividers>
          <div className="flex items-center">
            ...
            <div className="text-start px-3">
              <h4 style={{color: themeMode==='dark'? '#fff' : '#000'}}>آرشیو ساکن</h4>
              <p className={themeMode==='dark'? "text-[#fff8]" : "text-[#0008]"}>آیا از آرشیو ساکن مطمئن هستید؟</p>
            </div>
          </div>
        </DialogContent>
