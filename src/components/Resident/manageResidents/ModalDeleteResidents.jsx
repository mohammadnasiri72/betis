...
export default function ModalDeleteResidents({ handleCloseMenu, resident, setIsLoading, setFlag }) {
  ...
  return (
    <>
      ...
      {!handleCloseMenu && (
        <div onClick={handleClickOpen} className=" text-xs">
          <div
            className={
              themeMode === 'dark'
                ? 'hover:bg-slate-700 flex items-center p-1 rounded-2xl duration-300 cursor-pointer'
                : 'hover:bg-slate-50 flex items-center p-1 rounded-2xl duration-300 cursor-pointer'
            }
          >
            <MdOutlineDelete className="text-red-500" />
        ...
        <DialogContent dividers>
          <div className="flex items-center">
            ...
            <div className="text-start px-3">
              <h4 style={{color: themeMode==='dark'? '#fff' : '#000'}}>حذف ساکن</h4>
        ...
        <DialogActions sx={{ backgroundColor: themeMode==='dark'? '#212b46' : '#f3f4f6' }}>
          ...
          <button
            ...
            <div className="px-2">
              <button
                onClick={() => {
                  deleteResidentHandler(resident);
                  handleClose();
                }}
