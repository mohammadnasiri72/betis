...
export default function ModalDeleteGuest({ handleCloseMenu, guest, setFlag, setIsLoading, setIsDelete }) {
  ...
  const deleteGuestHandler = () => {
    setIsLoading(true);
    axios
      .delete(`${mainDomain}/api/Guest/Delete/${guest.id}`, {
        headers: {
        ...
        <DialogContent dividers>
          <div className="flex items-center">
            ...
            <div className="text-start px-3">
              <h4 style={{ color: themeMode === 'dark' ? '#fff' : '#000' }}>حذف مهمان</h4>
