...
export default function DeleteFeedback({feedback , setFlag , setIsLoading}) {
  ...
  const deleteFeedbackHandler = ()=>{
    setIsLoading(true)
    axios.delete(`${mainDomain}/api/Feedback/Delete/${feedback.id}`, {
        headers: {
    ...
    <>
       <Tooltip title="حذف">
          <IconButton onClick={handleClickOpen}>
            <DeleteIcon sx={{ color: 'rgb(248 113 113)' }} />
          </IconButton>
        </Tooltip>
        <BootstrapDialog
