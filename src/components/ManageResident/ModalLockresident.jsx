    ...
    <>
      <MenuItem onClick={handleClickOpen}>
        <div className="flex items-center text-xs">
          ...
          <Stack style={{color: resident.isLocked ? 'rgb(74 222 128)':'rgb(248 113 113)' }} className="px-1">{resident.isLocked ? 'رفع تحریم ساکن' : 'تحریم ساکن'}</Stack>
        </div>
      </MenuItem>
      <BootstrapDialog
        ...
        <DialogContent dividers>
          <div className="flex items-center">
            ...
            <div className="text-start px-3">
              <h4>{ !resident.isLocked ?  'تحریم ساکن' : 'رفع تحریم ساکن'}</h4>
              <p className="text-[#0008]">آیا از {!resident.isLocked ? 'تحریم':'رفع تحریم'} ساکن مطمئن هستید؟</p>
            </div>
          </div>
        </DialogContent>
          ...
          <div className="flex items-center justify-start w-full">
            ...
            <div className="px-2">
              <button
                ...
                className={!resident.isLocked? "border text-white bg-red-400 px-3 py-1 rounded-lg border-[#0002] duration-300 hover:bg-red-500" : "border text-white bg-green-400 px-3 py-1 rounded-lg border-[#0002] duration-300 hover:bg-green-500"}
              >
                تایید
              </button>
            </div>
