...
export default function ModalDeletePet({ handleCloseMenu, setFlag, setIsLoading, pet }) {
  ...
  const deletePetHandler = () => {
    setIsLoading(true);
    axios
      .delete(`${mainDomain}/api/Pet/Delete/${pet.id}`, {
        headers: {
        ...
        <DialogContent dividers>
          <div className="flex items-center">
            ...
            <div className="text-start px-3">
              <h4 style={{ color: themeMode === 'dark' ? '#fff' : '#000' }}>حذف حیوان خانگی</h4>
