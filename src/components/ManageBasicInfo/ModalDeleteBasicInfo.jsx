...
export default function ModalDeleteBasicInfo({ handleCloseMenu, setFlag, setIsLoading, info }) {
  ...
  //   delete handler
  const deleteBasicInfoHandler = () => {
    setIsLoading(true);
    axios
      .delete(`${mainDomain}/api/BasicInfo/Delete/${info.id}`, {
        headers: {
        ...
        <DialogContent dividers>
          <div className="flex items-center">
            ...
            <div className="text-start px-3">
              <h4 style={{ color: themeMode === 'dark' ? '#fff' : '#000' }}>حذف اطلاعات پایه</h4>
