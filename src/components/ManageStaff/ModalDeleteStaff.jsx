...
export default function ModalDeleteStaff({ handleCloseMenu, setFlag, setIsLoading, staff }) {
  ...
  const deleteStaffHandler = () => {
    setIsLoading(true);
    axios
      .delete(`${mainDomain}/api/Staff/Delete/${staff.id}`, {
        headers: {
        ...
        <DialogContent dividers>
          <div className="flex items-center">
            ...
            <div className="text-start px-3">
              <h4 style={{ color: themeMode === 'dark' ? '#fff' : '#000' }}>حذف پرسنل</h4>
