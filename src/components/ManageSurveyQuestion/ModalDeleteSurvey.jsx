...
export default function ModalDeleteSurvey({ handleCloseMenu, setFlag, setIsLoading, survey }) {
  ...
  const deleteStaffHandler = () => {
    setIsLoading(true);
    axios
      .delete(`${mainDomain}/api/SurveyQuestion/Delete/${survey.id}`, {
        headers: {
    ...
    <>
      <MenuItem onClick={handleClickOpen}>
        <div className="flex items-center text-xs">
          <MdOutlineDelete style={{ fontSize: '1rem' }} className="text-red-500" />
        ...
        <DialogContent dividers>
          <div className="flex items-center">
            ...
            <div className="text-start px-3">
              <h4 style={{ color: themeMode === 'dark' ? '#fff' : '#000' }}>حذف سوال</h4>
