    ...
    if (trimmedUsername.match(paternMobile)) {
      ...
      axios
        ...
        .catch((err) => {
          ...
          Toast.fire({
            icon: 'error',
            text: err.response ? err.response.data : 'خطا در برقراری ارتباط با سرور. لطفاً بعداً دوباره امتحان کنید',
            customClass: {
              container: 'toast-modal',
            },
          });
          ...
          <div className="flex">
            ...
            <div className="flex flex-col w-full  min-h-screen sm:justify-center justify-start items-center sm:px-0 px-5 bg-[#00005e]">
              ...
              <div className="pb-5 lg:w-1/3 sm:w-2/3 w-full text-start">
                <h3 className="text-start w-full text-2xl font-semibold text-white mt-5">بازیابی رمز!</h3>
