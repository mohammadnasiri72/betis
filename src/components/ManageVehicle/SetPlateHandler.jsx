    ...
    <>
        ...
        <div>
          ...
          >
            ...
            <div dir="ltr" className="flex px-1 w-full my-3 items-center">
              ...
              <div style={{backgroundColor: themeMode === 'dark' ? '' : '#f2f3f5'}} className="px-1 w-1/4 flex items-center border py-0 rounded-lg justify-between">
                <TextField
                  sx={{
      ...
      {valTypeVehicle === 2 && (
        <div className="w-full">
          ...
          >
            <Typography style={{ color: themeMode === 'dark' ? '#fff' : '#000' }} variant="h6" className={errLicensePlateMotor ? 'mb-4 text-red-500' : 'mb-4'}>
              شماره پلاک را وارد کنید
            </Typography>
